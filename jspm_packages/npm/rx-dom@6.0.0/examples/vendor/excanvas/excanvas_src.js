      ...
      var G_vmlCanvasManager_ = {
        ...
        init_: function(doc) {
          ...
          if (!doc.styleSheets['ex_canvas_']) {
            ...
            ss.cssText = 'canvas{display:inline-block;overflow:hidden;' + 'text-align:left;width:300px;height:150px}' + 'g_vml_\\:fill{behavior:url(#default#VML)}' + 'g_vml_\\:group{behavior:url(#default#VML)}' + 'g_vml_\\:image{behavior:url(#default#VML)}' + 'g_vml_\\:shape{behavior:url(#default#VML)}' + 'g_vml_\\:stroke{behavior:url(#default#VML)}' + 'g_o_\\:fill{behavior:url(#default#VML)}' + 'g_o_\\:group{behavior:url(#default#VML)}' + 'g_o_\\:image{behavior:url(#default#VML)}' + 'g_o_\\:shape{behavior:url(#default#VML)}' + 'g_o_\\:stroke{behavior:url(#default#VML)}';
          }
