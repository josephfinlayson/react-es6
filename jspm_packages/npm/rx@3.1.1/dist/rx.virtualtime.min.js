...
(function(a) {
  ...
  var f = c.Scheduler,
      g = c.internals.ScheduledItem,
      h = c.internals.SchedulePeriodicRecursive,
      i = c.Disposable.empty,
      j = c.internals.inherits,
      k = c.helpers.defaultSubComparer,
      l = c.helpers.notImplemented;
  e.prototype.compareTo = function(a) {
    var b = this.value.compareTo(a.value);
    return 0 === b && (b = this.id - a.id), b;
  };
  var m = c.internals.PriorityQueue = function(a) {
    this.items = new Array(a), this.length = 0;
  },
      n = m.prototype;
  n.isHigherPriority = function(a, b) {
    return this.items[a].compareTo(this.items[b]) < 0;
  }, n.percolate = function(a) {
  ...
  }, n.enqueue = function(a) {
    var b = this.length++;
    this.items[b] = new e(m.count++, a), this.percolate(b);
  }, n.remove = function(a) {
  ...
  c.VirtualTimeScheduler = function(a) {
    function b() {
    ...
    function k(f, g) {
      this.clock = f, this.comparer = g, this.isEnabled = !1, this.queue = new m(1024), a.call(this, b, c, d, e);
    }
    j(k, a);
    var n = k.prototype;
    return n.add = l, n.toDateTimeOffset = l, n.toRelative = l, n.schedulePeriodicWithState = function(a, b, c) {
      ...
      var e = this,
          f = new g(this, a, d, b, this.comparer);
      return this.queue.enqueue(f), f.disposable;
    }, k;
  }(f);
  return c.HistoricalScheduler = function(a) {
    function b(b, c) {
      var d = null == b ? 0 : b,
          e = c || k;
      a.call(this, d, e);
